...
#define STEEM_ACCOUNT_SUBSIDY_WITNESS_OVERSUB               (200 * STEEM_1_PERCENT)
#define STEEM_ACCOUNT_SUBSIDY_MAX_BURST_BLOCKS              (30 * STEEM_BLOCKS_PER_DAY)
#define STEEM_ACCOUNT_SUBSIDY_DEFAULT_BURST_BLOCKS          (2 * STEEM_BLOCKS_PER_DAY)
#define STEEM_ACCOUNT_SUBSIDY_DEFAULT_ACCOUNTS_PER_DAY      ( 5000 * STEEM_ACCOUNT_SUBSIDY_PRECISION)
#define STEEM_ACCOUNT_SUBSIDY_MAX_ACCOUNTS_PER_DAY          (50000 * STEEM_ACCOUNT_SUBSIDY_PRECISION)
